...
--
-- Host: localhost:3306
-- Generation Time: May 26, 2019 at 02:33 AM
...
(8, 0, 10, '0000-00-00 00:00:00', '2019-05-26'),
...
(0, 'dsaasddas', '', 'eqreeq', 'rreeew', 'wwwreewr', 0, 0, ''),
...
--
-- Table structure for table `soalquiz2`
--

CREATE TABLE `soalquiz2` (
  `IDsoal` int(11) NOT NULL,
  `soal` text NOT NULL,
...
--
-- Dumping data for table `soalquiz2`
--

INSERT INTO `soalquiz2` (`IDsoal`, `soal`, `jawaban1`, `jawaban2`, `jawaban3`, `jawaban4`, `pilihan1`, `pilihan2`, `pilihan3`, `pilihan4`, `idquiz`, `bobot`, `images`) VALUES
(0, 'apakah anda setujuh?', 'sangat stj', 'oke setuhju', 'yess', 'setujuh', 'ss', 's', 'sts', 'ts', 0, 50, ''),
(1, 'pake sendal pas kerja ??', 'sangat setuju', 'setuju', 'tidak setuju', 'sangat tidak setuju', 'ss', 's', 'ts', 'sts', 0, 50, '');
...
--
-- Indexes for table `soalquiz2`
--
ALTER TABLE `soalquiz2`
  ADD PRIMARY KEY (`IDsoal`);
